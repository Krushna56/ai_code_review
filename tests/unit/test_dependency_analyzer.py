...
class TestDependencyAnalyzer:
    ...
    def setup_method(self):
        ...
        self.fixtures_dir = Path(__file__).parent.parent / 'fixtures' / 'dependencies'
    ...
    def test_parse_pom_xml(self):
        ...
        log4j_deps = [d for d in dependencies if 'log4j' in d.package_name.lower()]
    ...
    def test_parse_gradle(self):
        ...
        assert len(dependencies) >= 0  # May or may not find deps depending on regex
