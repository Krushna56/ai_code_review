        ...
        try:
            ...
            if is_code_file:
                ...
                analysis = analyzer.analyze_complete(
                    code_content, language, filename)
                ...
                # Process document
                text, page_count = DocumentProcessor.process_document(
                    file_path)
                ...
                if summary_type == 'quick':
                    ...
                    # 6 lines per page, min 10
                    requested_lines = max(10, page_count * 6)
                ...
                result = ai_summarizer.analyze_document(
                ...
                if requested_lines and requested_lines < result['minimum_lines']:
                    warning_message = f"Note: {summary_type.capitalize()} summary requested, but minimum recommended is {
                        result['minimum_lines']} lines for a {page_count}-page document. Using {result['actual_lines']} lines."
